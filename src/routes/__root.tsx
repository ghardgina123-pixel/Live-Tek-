...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Live Teká — Bem-vindo · Compre, Converse, Receba" },
      { name: "twitter:description", content: "Bem-vindo à Live Teká: o marketplace ao vivo de Angola. Entre como cliente ou lojista e comece em segundos." },
